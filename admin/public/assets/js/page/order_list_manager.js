 (function() {
    ...
    jQuery(function($) {
        ...
        $ynf_list.jqGrid({
            ...
            caption: "Order List",
            autowidth: true,
            colNames: ["ID", "Booking Time","Invoice No","Reference","Company", "Agent","Tour Code","Total Pax", "Order Amount", "Order Status" , "Payment Status","Operation"],
        ...
        function oper_formatter(cellvalue, options, rowdata) {
            ...
            var oper_check = ['<a ',
                ' target="_self"  href="./show?id=', rowdata.id, '"',
                style,
                ' class="c-green" title="On Time">View Details</a><br /><br />'
