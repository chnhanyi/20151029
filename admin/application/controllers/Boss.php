<?php
	...
	class Boss extends  MY_Controller{
		...
		//展示订单列表
		function index(){
			$this->load->view("boss/order_list.html");
		}
		...
		function get_data(){			
			...
			$count 	= $this->Boss_model->count_Order($where);
			$list 	= $this->Boss_model->get_all_orders($where,$start,$limit);			
